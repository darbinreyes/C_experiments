...
char *strncpy0(char *s, const char *t, size_t n) {
  char *ts;
...
**/
char *strncat0(char *s, const char *t, size_t n) {
  char *ts;
...
void test_strncat(void) {
  ...
  char *t = ". When is the time?";

  printf("test_strncat\n");

  strncat0(s, t, 6);
  printf("Test 1. correct = \"Now is the time. When\", mine got = \"%s\".\n", s);
}
